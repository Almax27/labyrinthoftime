...
int AStar::aStarSearch(int grid[][COL], Pair src, Pair dest)
{
    ...
    {
        //printf("Destination is invalid -1\n");
        return -1;
    }
    ...
    {
        //printf("Source or the destination is blocked -1\n");
        return -1;
    }
    ...
    {
        //printf("We are already at the destination 0\n");
        return -1;
    }
    ...
    {
        return -1;
        //printf("Failed to find the Destination Cell-1\n");
    }
